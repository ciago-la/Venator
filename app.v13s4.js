// === Altervenator v13s4 — Diaria + Clase + Urgentes + Tienda/Inventario + Consumibles + Avatar ===
(function(){
  ...
  // ---------- Aplicación de consumibles a misión ----------
  function add2h(m){
    if (!m.dueAt) return;
  ...
  function renderHeader(){
    setHeader();
    ['pLvl','pXP','pXPNeed','pCoins','pNerf','cLvl','cXP','cXPNeed'].forEach(function(id){}); // silencioso si faltan
    var el;
  ...
  function renderShop(){
    ...
    // Inventario (usar exp/cure globales desde aquí)
  ...
  // Clicks globales: compras, acciones misión, consumibles
