// === Altervenator · app.v14.js ===
// Cambios clave:
// - Llaves + Asalto a mazmorra (idéntico a urgente pero forzado, consumiendo llave).
// - Llaves: +1 al completar URGENTE y +1 cada 3 niveles subidos (acumulativo).
// - Diaria única por día, Focus/Clase con límite 2/día, pools aleatorios por clase.
// - Pity timer de urgentes (10% base, sube si pasan días sin urgente, máx 30%).
// - Perfiles (guardar/cargar/exportar/importar), tienda+inventario+equipo PNGs.
// - Overlays de notificación (verde/amarillo/rojo) y “Castigador” en versión dura.
// - FIX: mkClassMission incluida y expuesta en window para evitar errores en HTML.
...
(function(){
  ...
  function gainXP(base){
    ...
    // Llaves por niveles: +1 cada 3 niveles netos
  ...
  function completeMission(m){
    ...
    decayNerf();
    // Loot 20% en urgentes o mazmorra
  ...
  document.addEventListener('click', function(e){
    ...
    // Crear Focus/Clase (con límites 2/día)
  ...
  // Prompt aceptar/rechazar (solo Focus/Clase)
