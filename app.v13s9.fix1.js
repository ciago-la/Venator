// === Altervenator app.v13s9.fix1.js ===
// Incluye: tabs funcionando, misiones (diaria única, focus/clase con límites),
// pools aleatorios de clase, pity timer de urgentes, perfiles guardar/cargar,
// tienda + inventario + equipar con PNGs, notificaciones overlay por color
// (verde/amarillo/rojo) y notificación especial del Castigador en Versión dura.

(function(){
  const VER='v13s9.fix1';
  ...
  // Banner rápido si hay errores JS para detectar por qué "no funciona nada"
  ...
  // --- economía ---
  function gainXP(base){ let g=base; if(Date.now()<state.expBuffUntil) g=Math.round(g*1.2); if(state.expNerfCount>0) g=Math.round(g*0.8); state.xp+=g;
  ...
  document.addEventListener('click', function(e){
    ...
    // crear focus/clase con límites diarios
    ...
    // inventario global (algunas pociones)
